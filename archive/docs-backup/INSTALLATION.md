...
2. Customize which browsers/profiles appear in [Preferences](../README.md#hiding-browsers)
3. Learn [keyboard shortcuts](../README.md#keyboard-shortcuts)
4. Explore the [system tray menu](../README.md#from-system-tray)

## Future Installation Methods

See [ROADMAP.md](../roadmap/ROADMAP.md) for planned improvements including:
